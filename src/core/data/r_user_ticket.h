...
// 通过ID 得到订单记录
r_ticket_user_t_p get_ticket_by_id(r_ticket_user_t_p *r_ticket_user, user_id_t user_id, ticket_id_t ticket_id);

// 通过ID 删除
user_id_t delete_ticket_by_user_id(r_ticket_user_t_p *r_ticket_user, user_id_t user_id);
ticket_id_t delete_ticket_by_ticket_id(r_ticket_user_t_p *r_ticket_user, ticket_id_t ticket_id);
